...
<table  class="table">
                ...
                <tbody> 
                 ...
                 @if($q->status == 1)
                 <tr>
                 <td scope="row"><center><p style="margin-top: 3%; font-size:30px">{{$q->user->name}}<p style="align-items: center; margin-left: 20%;">{!!QrCode::size(170)->generate($q->id)!!}</p></p></center></td>
                </tr>
                @endif
                @endforeach
              </tbody>
