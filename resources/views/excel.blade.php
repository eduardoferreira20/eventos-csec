...
<table  class="table">
                ...
                <tbody> 
                 ...
                 @if($q->status == 1)
                 <tr>
                 <td scope="row"><center><p style="margin-top: 3%; font-size:30px">{{substr($q->user->name,0,18)}}<p style="align-items: center;margin-bottom: 14%">{!!QrCode::size(170)->generate($q->id)!!}</p></p></center></td>
                </tr>
                @endif
                @endforeach
              </tbody>
